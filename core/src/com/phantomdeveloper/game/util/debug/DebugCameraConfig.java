package com.phantomdeveloper.game.util.debug;
...
/**
 * Created by Phantom on 2/2/2018.
 */
...
public class DebugCameraConfig {
    ...
    // names/keys in key-value map -> names of values inside json file
    ...
    public void init() {
        ...
        if (fileHandle.exists()) {
            ...
            log.info("Default config file does not exist :" + FILE_PATH);
            setupDefaults();
        }
    }
